...
@csrf
    ...
    <div class="col-md-1">
        ...
        <div class="col-md-1">
        <label for="bota">Editar</label>
        <button type="button" id="bota" onclick="window.location='http://google.com'">link1</button>
        </div>
...
<option value="{{$event->graui}}">{$event->estadonatu}</option>
